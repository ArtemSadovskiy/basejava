<%@ page import="com.crud.webapp.model.ContactType" %>
<%@ page import="com.crud.webapp.model.SectionType" %>
<%@ page import="com.crud.webapp.model.ListSection" %>
<%@ page import="com.crud.webapp.model.OrganizationSection" %>
<%@ page import="com.crud.webapp.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.crud.webapp.model.Organization.Position"/>
                                <dl>
